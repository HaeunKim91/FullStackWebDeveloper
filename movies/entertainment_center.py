...
inside_out = media.Movie("Inside Out",
                        "A story of emotions living in Headquarters, the control center inside Riley's mind",
...
about_time = media.Movie("About Time",
                         "A love story about a man who can travel through time",
...
queen = media.Movie("Queen",
                    "A woman who finds joy, makes friends, and gains new-found independence",
...
if_only = media.Movie("If only", "If you had one day more with the girl of your dreams, what would you do?",
                      "http://www.gstatic.com/tv/thumb/movieposters/160181/p160181_p_v8_ae.jpg",
                      "https://www.youtube.com/watch?v=3z5XDNHmBco")

breakfast_at_tiffany = media.Movie("Breakfast at Tiffany's", "the story of a young woman in NYC who meets a young man",
